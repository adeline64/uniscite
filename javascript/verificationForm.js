...
var Adresse = document.getElementById('adresse1');
...
var motPass_m = document.getElementById('password_manquant');
...
function f_valid(e) {
    ...
    if (motPass.validity.valueMissing) {
        e.preventDefault();
        motPass_m.textContent = 'mot de passe manquant';
        motPass_m.style.color = 'red';
    }
